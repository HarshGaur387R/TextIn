...
function App() {
  ...
  const [selectedCheckBox,setSelectedCheckBox] = useState('flexRadioDefault1');
  ...
  return (
    ...
    <Router>
      <div id="App">
        ...
        <Navbar title={'TextIn'} theme={theme} isDarkModeEnable={isDarkModeEnable} toggleDarkModeState={toggleDarkModeState} setShowTextSearchWindow={setShowTextSearchWindow} showTextSearchWindow={showTextSearchWindow} setSearchBoxText={setSearchBoxText} searchBoxText={searchBoxText}/>
        ...
        <TextSearchWindow showTextSearchWindow={showTextSearchWindow} setShowTextSearchWindow={setShowTextSearchWindow} searchBoxText={searchBoxText} setModifiedText={setModifiedText} modifiedText={modifiedText} selectedCheckBox={selectedCheckBox}/>
        ...
        <Routes>
          ...
          <Route path="/settings" element={<Settings showColorPalette={showColorPalette} setShowColorPalette={setShowColorPalette} listOfColors={listOfColors} isDarkModeEnable={isDarkModeEnable} theme={theme} setTheme={setTheme} setSelectedCheckBox={setSelectedCheckBox} selectedCheckBox={selectedCheckBox}/>}/>
        </Routes>
